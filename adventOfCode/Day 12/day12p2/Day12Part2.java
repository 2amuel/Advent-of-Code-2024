...
public class Day12Part2{
	...
	if(i == 0 || (!map[i-1][j].equals(letter) && !map[i-1][j].equals(","))){
	    if(j == 0 || !((map[i][j-1].equals(",")||map[i][j-1].equals(letter)) && (i == 0 || !(map[i-1][j-1].equals(",")||map[i-1][j-1].equals(letter)))))
		perimeter++;
	}
	    ...
	    if(j == 0 || !((map[i][j-1].equals(",")||map[i][j-1].equals(letter)) && (i == map.length - 1 || !(map[i+1][j-1].equals(",")||map[i+1][j-1].equals(letter)))))
                perimeter++;
	}
        else if(map[i+1][j].equals(letter)){
            int[] temp = calcAreaAndPerimeter(map, i+1, j);
	    ...
	    if(i == 0 || !((map[i-1][j].equals(",")||map[i-1][j].equals(letter)) && (j == 0 || !(map[i-1][j-1].equals(",")||map[i-1][j-1].equals(letter)))))
        	perimeter++;
	}
	    ...
	    if(i == 0 || !((map[i-1][j].equals(",")||map[i-1][j].equals(letter)) && (j == map[i].length - 1 || !(map[i-1][j+1].equals(",")||map[i-1][j+1].equals(letter)))))
        	perimeter++;
	}
        else if(map[i][j+1].equals(letter)){
            int[] temp = calcAreaAndPerimeter(map, i, j+1);
